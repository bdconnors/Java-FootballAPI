...
public class FootballDatabase {
    ...
    public boolean close() throws DLException {
        boolean status = true;
        try {
            if (conn != null && conn.getAutoCommit()) { //atempt to close connection
                conn.close();
                status = true;
            }
        } catch (Exception e) {
    ...
    //----------------------------------------------------------------------------------------------------
    public ArrayList<String[]> getData(String query, ArrayList<String> list) throws DLException {  //arraylist to hold data returned from database
        ...
        try {
            ...
            while (rs.next()) {
                ...
                //for every column
                for (int i = 1; i <= colCount; i++) {  //get the value in that column
    ...
    public ArrayList<String[]> getData(String query) throws DLException {
        ...
        try {  //creates statement to send
            ...
            close();
        } catch (Exception e) { //throw new DLException sending error message and relevant information
    ...
    //---------------------------------------------------------------------------------------------------
    public int setData(String update, ArrayList<String> list) throws DLException {  //connect to db
        connect();
        //effected rows
        int effected = 0;
        try {   //execute update
    ...
    //---------------------------------------------------------------------------------------------------
    public int executeStmnt(String update, ArrayList<String> list) throws DLException {   //prepared statement
