SELECT  player.playerid,playercummisc.gplayed,jerseynumber,pos,player.firstname,player.lastname,team,passatt,passcomp,passyds,passtds,intthr,rushatt,rushyds,rushtd,fum
 FROM player
